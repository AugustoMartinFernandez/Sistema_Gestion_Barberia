...
rlutil::setColor(rlutil::YELLOW);
  rlutil::locate(32, 21);   cout<<"1-  Informes Financieros (Recaudacion, etc.) "<<endl;
  rlutil::locate(32, 25);   cout<<"2-  Informes de gestion de clientes y agenda "<<endl;
...
switch (opcion){
 case 1:  {InformesFinancieros ();
                  break;  }
  case 2: { InformesGestionClientes ();
               break;   }
  case 0:  {
            MenuManager volver;
...
void  MenuInformes::InformesFinancieros ()const{
 ...
 rlutil::locate(27, 18); cout<< " E s t a s  e n:  S u b M e n u - I n f . F i n a n c i e r o s ";
rlutil::setColor(rlutil::BLUE);
 rlutil::locate(27, 19);   cout<< "ษออออออออออออออออออออออออออออออออออออออออออออออออออออป";
 rlutil::setColor(rlutil::WHITE);
rlutil::locate(27, 20);    cout<< "บ                                                    บ";
...
rlutil::locate(27, 27);   cout<<  "ศออออออออออออออออออออออออออออออออออออออออออออออออออออผ";
   ...
   rlutil::setColor(rlutil::YELLOW);
rlutil::locate(32, 20);    cout<<"1-  Recaudacion (Diaria, Mensual, Anual.) "<<endl;
 rlutil::locate(32, 22);    cout<<"2-  Servicios Mas solicitados "<<endl;
rlutil::locate(32, 24);    cout<<"3-  Barbero que mas cortes hizo"<<endl;
 rlutil::locate(32, 26);    cout<<"4-  Metodos de pago utilizados "<<endl;
...
void MenuInformes::InformesGestionClientes ()const{
 int opcion;
  ...
  rlutil::locate(27, 18); cout<< " E s t a s  e n:  S u b M e n u - I n f . G e s t i o n C l i e n t";
rlutil::setColor(rlutil::BLUE);
 rlutil::locate(27, 19);   cout<< "ษออออออออออออออออออออออออออออออออออออออออออออออออออออป";
 rlutil::setColor(rlutil::WHITE);
rlutil::locate(27, 20);    cout<< "บ                                                    บ";
...
rlutil::setColor(rlutil::YELLOW);
 rlutil::locate(32, 20);    cout<<"1-  Clientes Frecuentes"<<endl;
 rlutil::locate(32, 24);    cout<< "2- Turnos realizados y cancelados"<<endl;
